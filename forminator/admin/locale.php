...
"Live mode Stripe keys are not configured. Connect live mode in Forminator payment settings first." => array( null, __("Live mode Stripe keys are not configured. Connect live mode in Forminator payment settings first.", "forminator"), ), // src/utils.js:1746
"Test mode Stripe keys are not configured. Connect test mode in Forminator payment settings first." => array( null, __("Test mode Stripe keys are not configured. Connect test mode in Forminator payment settings first.", "forminator"), ), // src/utils.js:1751
"Please fix the error(s) in the PRODUCTS/PLANS tab." => array( null, __("Please fix the error(s) in the PRODUCTS/PLANS tab.", "forminator"), ), // src/utils.js:1768
"Please fix the error(s) in the SETTINGS tab." => array( null, __("Please fix the error(s) in the SETTINGS tab.", "forminator"), ), // src/utils.js:1769
"Stripe Subscription Add-on is required." => array( null, __("Stripe Subscription Add-on is required.", "forminator"), ), // src/utils.js:1788
"Billing frequency should be greater than or equal to 1" => array( null, __("Billing frequency should be greater than or equal to 1", "forminator"), ), // src/utils.js:1823
"Use form settings (Above inputs)" => array( null, __("Use form settings (Above inputs)", "forminator"), ), // src/utils.js:1920
"Use form settings (Below inputs)" => array( null, __("Use form settings (Below inputs)", "forminator"), ), // src/utils.js:1920
...
"Export" => array( null, __("Export", "forminator"), ), // src/global/components/meta/more-option.js:327
"Documentation" => array( null, __("Documentation", "forminator"), ), // src/global/components/meta/more-option.js:344
...
"Could not load latest sequence settings. Showing current values instead." => array( null, __("Could not load latest sequence settings. Showing current values instead.", "forminator"), ), // src/form/components/settings.js:163
"Sequential Form ID" => array( null, __("Sequential Form ID", "forminator"), ), // src/form/components/settings.js:178
"Create a custom ID sequence for this form's submissions." => array( null, __("Create a custom ID sequence for this form's submissions.", "forminator"), ), // src/form/components/settings.js:180
"Enable custom ID sequence" => array( null, __("Enable custom ID sequence", "forminator"), ), // src/form/components/settings.js:186
"ID Preview" => array( null, __("ID Preview", "forminator"), ), // src/form/components/settings.js:192
"Preview of the ID that will be assigned to the next submission of this form." => array( null, __("Preview of the ID that will be assigned to the next submission of this form.", "forminator"), ), // src/form/components/settings.js:194
"Open Sequential Form ID settings" => array( null, __("Open Sequential Form ID settings", "forminator"), ), // src/form/components/settings.js:205
"remove" => array( null, __("remove", "forminator"), ), // src/form/components/settings.js:244
"retain" => array( null, __("retain", "forminator"), ), // src/form/components/settings.js:244
"By default we will store all submissions in your database." => array( null, __("By default we will store all submissions in your database.", "forminator"), ), // src/form/components/settings.js:265
"User’s Geolocation" => array( null, __("User’s Geolocation", "forminator"), ), // src/form/components/settings.js:288
"Enabling this option will attempt to collect and store users' location information when this form is submitted." => array( null, __("Enabling this option will attempt to collect and store users' location information when this form is submitted.", "forminator"), ), // src/form/components/settings.js:291
"Enable current user’s Geolocation" => array( null, __("Enable current user’s Geolocation", "forminator"), ), // src/form/components/settings.js:298
"Enable the checkbox to make it mandatory for users to grant access to the location permission to submit this form." => array( null, __("Enable the checkbox to make it mandatory for users to grant access to the location permission to submit this form.", "forminator"), ), // src/form/components/settings.js:303
"Require access to users' location" => array( null, __("Require access to users' location", "forminator"), ), // src/form/components/settings.js:307
"Error message" => array( null, __("Error message", "forminator"), ), // src/form/components/settings.js:313
"Enter message" => array( null, __("Enter message", "forminator"), ), // src/form/components/settings.js:314
"Multiple Option Value" => array( null, __("Multiple Option Value", "forminator"), ), // src/form/components/settings.js:325
"Choose how you want to handle multiple option values in form submissions and email notifications." => array( null, __("Choose how you want to handle multiple option values in form submissions and email notifications.", "forminator"), ), // src/form/components/settings.js:329
"Default Stored Value" => array( null, __("Default Stored Value", "forminator"), ), // src/form/components/settings.js:337
"By default, we store option labels of multiple option fields ({{strong}}e.g., Radio, Checkbox, and Select{{/strong}}) in submissions, and use the same in email notifications. You can choose to use option values instead." => array( null, __("By default, we store option labels of multiple option fields ({{strong}}e.g., Radio, Checkbox, and Select{{/strong}}) in submissions, and use the same in email notifications. You can choose to use option values instead.", "forminator"), ), // src/form/components/settings.js:341
"Option labels" => array( null, __("Option labels", "forminator"), ), // src/form/components/settings.js:356
"Option values" => array( null, __("Option values", "forminator"), ), // src/form/components/settings.js:358
"Email Image Options" => array( null, __("Email Image Options", "forminator"), ), // src/form/components/settings.js:367
"Choose how images are shown in email notifications. You can embed images directly in the email or display them as clickable links." => array( null, __("Choose how images are shown in email notifications. You can embed images directly in the email or display them as clickable links.", "forminator"), ), // src/form/components/settings.js:371
"Image Link" => array( null, __("Image Link", "forminator"), ), // src/form/components/settings.js:383
"This setting applies to images from E-Signature and File Upload fields." => array( null, __("This setting applies to images from E-Signature and File Upload fields.", "forminator"), ), // src/form/components/settings.js:398
"Image Preview" => array( null, __("Image Preview", "forminator"), ), // src/form/components/settings.js:405
"This setting applies to images from E-Signature, File Upload, Radio, and Checkbox fields." => array( null, __("This setting applies to images from E-Signature, File Upload, Radio, and Checkbox fields.", "forminator"), ), // src/form/components/settings.js:420
"Choose how you want to handle this form's data storage." => array( null, __("Choose how you want to handle this form's data storage.", "forminator"), ), // src/form/components/settings.js:438
"By default we will use the configuration you have set in your" => array( null, __("By default we will use the configuration you have set in your", "forminator"), ), // src/form/components/settings.js:443
"How long do you want to retain this form's submissions for?" => array( null, __("How long do you want to retain this form's submissions for?", "forminator"), ), // src/form/components/settings.js:458
"Your default setting value is to keep the submissions" => array( null, __("Your default setting value is to keep the submissions", "forminator"), ), // src/form/components/settings.js:486
"Days" => array( null, __("Days", "forminator"), ), // src/form/components/settings.js:520
"Weeks" => array( null, __("Weeks", "forminator"), ), // src/form/components/settings.js:523
"Months" => array( null, __("Months", "forminator"), ), // src/form/components/settings.js:526
"Years" => array( null, __("Years", "forminator"), ), // src/form/components/settings.js:529
"Account Erasure Requests" => array( null, __("Account Erasure Requests", "forminator"), ), // src/form/components/settings.js:545
"When handling an account erasure request that contains an email associated with a submission, what do you want to do?" => array( null, __("When handling an account erasure request that contains an email associated with a submission, what do you want to do?", "forminator"), ), // src/form/components/settings.js:549
"Your default setting value is to " => array( null, __("Your default setting value is to ", "forminator"), ), // src/form/components/settings.js:579
" the submission." => array( null, __(" the submission.", "forminator"), ), // src/form/components/settings.js:581
"Retain Submissions" => array( null, __("Retain Submissions", "forminator"), ), // src/form/components/settings.js:602
"Remove Submissions" => array( null, __("Remove Submissions", "forminator"), ), // src/form/components/settings.js:605
"Submission Files" => array( null, __("Submission Files", "forminator"), ), // src/form/components/settings.js:614
"If your form has file upload field(s), choose whether to delete the file(s) related to a submission when that submission gets deleted." => array( null, __("If your form has file upload field(s), choose whether to delete the file(s) related to a submission when that submission gets deleted.", "forminator"), ), // src/form/components/settings.js:617
"Keep" => array( null, __("Keep", "forminator"), ), // src/form/components/settings.js:627
...
"{{b}}Warning!{{/b}} You are using the Stripe simple Card Element which is being deprecated and will be removed in an upcoming Forminator release. To avoid failed payments, migrate to the new Stripe Payment Element field." => array( null, __("{{b}}Warning!{{/b}} You are using the Stripe simple Card Element which is being deprecated and will be removed in an upcoming Forminator release. To avoid failed payments, migrate to the new Stripe Payment Element field.", "forminator"), ), // src/form/components/builder.js:88
...
"At least one field must be enabled" => array( null, __("At least one field must be enabled", "forminator"), ), // src/form/components/modals/settings.js:165
"Please fill required fields" => array( null, __("Please fill required fields", "forminator"), ), // src/form/components/modals/settings.js:171
"Calculation values are required!" => array( null, __("Calculation values are required!", "forminator"), ), // src/form/components/modals/settings.js:189
"Option labels are required!" => array( null, __("Option labels are required!", "forminator"), ), // src/form/components/modals/settings.js:198
"Add one or more options to add this field." => array( null, __("Add one or more options to add this field.", "forminator"), ), // src/form/components/modals/settings.js:206
"Please add a placeholder or select a default option." => array( null, __("Please add a placeholder or select a default option.", "forminator"), ), // src/form/components/modals/settings.js:220
"At least one of Title, Content, or Excerpt must be enabled for post data to be submitted." => array( null, __("At least one of Title, Content, or Excerpt must be enabled for post data to be submitted.", "forminator"), ), // src/form/components/modals/settings.js:230
"You need at least one payment plan!" => array( null, __("You need at least one payment plan!", "forminator"), ), // src/form/components/modals/settings.js:246
"Please select an email address for payment receipt." => array( null, __("Please select an email address for payment receipt.", "forminator"), ), // src/form/components/modals/settings.js:252
"Empty labels are not allowed for meta values!" => array( null, __("Empty labels are not allowed for meta values!", "forminator"), ), // src/form/components/modals/settings.js:263
"Billing Address field is required, and its Country subfield must be enabled." => array( null, __("Billing Address field is required, and its Country subfield must be enabled.", "forminator"), ), // src/form/components/modals/settings.js:281
"Please connect your PayPal account first!" => array( null, __("Please connect your PayPal account first!", "forminator"), ), // src/form/components/modals/settings.js:304
"Please enter PayPal payment amount!" => array( null, __("Please enter PayPal payment amount!", "forminator"), ), // src/form/components/modals/settings.js:309
"Please select PayPal payment variable field!" => array( null, __("Please select PayPal payment variable field!", "forminator"), ), // src/form/components/modals/settings.js:315
"Limit Min value should be less than Max value." => array( null, __("Limit Min value should be less than Max value.", "forminator"), ), // src/form/components/modals/settings.js:333
"Please enter API keys." => array( null, __("Please enter API keys.", "forminator"), ), // src/form/components/modals/settings.js:355
"Please select a valid end time limit." => array( null, __("Please select a valid end time limit.", "forminator"), ), // src/form/components/modals/settings.js:454
"Please fix the Default time error." => array( null, __("Please fix the Default time error.", "forminator"), ), // src/form/components/modals/settings.js:460
"Please fix the Start or End time." => array( null, __("Please fix the Start or End time.", "forminator"), ), // src/form/components/modals/settings.js:474
"Please fix the limit Start or End date." => array( null, __("Please fix the limit Start or End date.", "forminator"), ), // src/form/components/modals/settings.js:612
"Maximum Rating value should be less than 50." => array( null, __("Maximum Rating value should be less than 50.", "forminator"), ), // src/form/components/modals/settings.js:623
"Default Rating must be a whole number." => array( null, __("Default Rating must be a whole number.", "forminator"), ), // src/form/components/modals/settings.js:633
"Default Rating must be between 1 and Maximum Rating." => array( null, __("Default Rating must be between 1 and Maximum Rating.", "forminator"), ), // src/form/components/modals/settings.js:636
"Customize %s" => array( null, __("Customize %s", "forminator"), ), // src/form/components/modals/settings.js:714
"Customize %s Field" => array( null, __("Customize %s Field", "forminator"), ), // src/form/components/modals/settings.js:715
"Customize Page Visibility" => array( null, __("Customize Page Visibility", "forminator"), ), // src/form/components/modals/settings.js:719
"Geolocation" => array( null, __("Geolocation", "forminator"), ), // src/form/components/modals/settings.js:802
"Geolocation {{span}}Pro{{/span}}" => array( null, __("Geolocation {{span}}Pro{{/span}}", "forminator"), ), // src/form/components/modals/settings.js:804
"Products/Plans" => array( null, __("Products/Plans", "forminator"), ), // src/form/components/modals/settings.js:831
"Repeater" => array( null, __("Repeater", "forminator"), ), // src/form/components/modals/settings.js:851
"Limits" => array( null, __("Limits", "forminator"), ), // src/form/components/modals/settings.js:865
"Customize" => array( null, __("Customize", "forminator"), ), // src/form/components/modals/settings.js:917
...
"Fill Empty Fields" => array( null, __("Fill Empty Fields", "forminator"), ), // src/form/components/modals/notification.js:552
"When enabled, any field placeholder in the subject or body that has no value will be replaced with \"N/A\"." => array( null, __("When enabled, any field placeholder in the subject or body that has no value will be replaced with \"N/A\".", "forminator"), ), // src/form/components/modals/notification.js:555
"Enabled" => array( null, __("Enabled", "forminator"), ), // src/form/components/modals/notification.js:570
"Some hosts do not allow \"from email\" to be overridden or replaced due to spam issues." => array( null, __("Some hosts do not allow \"from email\" to be overridden or replaced due to spam issues.", "forminator"), ), // src/form/components/modals/notification.js:828
...
"ID Prefix can be no more than 16 characters." => array( null, __("ID Prefix can be no more than 16 characters.", "forminator"), ), // src/form/components/modals/custom-sequence-settings.js:35
"ID Prefix can contain only letters, numbers, spaces, hyphens and underscores." => array( null, __("ID Prefix can contain only letters, numbers, spaces, hyphens and underscores.", "forminator"), ), // src/form/components/modals/custom-sequence-settings.js:39
"Starting Number must be 1 or greater." => array( null, __("Starting Number must be 1 or greater.", "forminator"), ), // src/form/components/modals/custom-sequence-settings.js:44
"ID Prefix" => array( null, __("ID Prefix", "forminator"), ), // src/form/components/modals/custom-sequence-settings.js:88
"Enter the custom prefix you'd like to use for this form's submissions. The prefix can be no more than 16 characters, and can contain only letters, numbers, spaces, hyphens and underscores." => array( null, __("Enter the custom prefix you'd like to use for this form's submissions. The prefix can be no more than 16 characters, and can contain only letters, numbers, spaces, hyphens and underscores.", "forminator"), ), // src/form/components/modals/custom-sequence-settings.js:91
"E.g. INFO-" => array( null, __("E.g. INFO-", "forminator"), ), // src/form/components/modals/custom-sequence-settings.js:97
"Starting Number" => array( null, __("Starting Number", "forminator"), ), // src/form/components/modals/custom-sequence-settings.js:108
"Specify the number at which this sequence should begin. Updating and saving this option changes the next generated ID number." => array( null, __("Specify the number at which this sequence should begin. Updating and saving this option changes the next generated ID number.", "forminator"), ), // src/form/components/modals/custom-sequence-settings.js:111
"Save" => array( null, __("Save", "forminator"), ), // src/form/components/modals/custom-sequence-settings.js:141
...
"Bulgarian (bg)" => array( null, __("Bulgarian (bg)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:338
"Croatian (hr)" => array( null, __("Croatian (hr)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:339
"Czech (cs)" => array( null, __("Czech (cs)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:340
"Estonian (et)" => array( null, __("Estonian (et)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:344
"Filipino (fil)" => array( null, __("Filipino (fil)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:345
"Greek (el)" => array( null, __("Greek (el)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:349
"Hungarian (hu)" => array( null, __("Hungarian (hu)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:350
"Indonesian (id)" => array( null, __("Indonesian (id)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:351
"Korean (ko)" => array( null, __("Korean (ko)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:354
"Latvian (lv)" => array( null, __("Latvian (lv)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:355
"Lithuanian (lt)" => array( null, __("Lithuanian (lt)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:356
"Malay (ms)" => array( null, __("Malay (ms)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:357
"Maltese (mt)" => array( null, __("Maltese (mt)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:358
"Norwegian Bokmål (nb)" => array( null, __("Norwegian Bokmål (nb)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:359
"Polish (pl)" => array( null, __("Polish (pl)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:360
"Portuguese (pt)" => array( null, __("Portuguese (pt)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:361
"Romanian (ro)" => array( null, __("Romanian (ro)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:362
"Slovak (sk)" => array( null, __("Slovak (sk)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:364
"Slovenian (sl)" => array( null, __("Slovenian (sl)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:365
"Thai (th)" => array( null, __("Thai (th)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:368
"Turkish (tr)" => array( null, __("Turkish (tr)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:369
"Vietnamese (vi)" => array( null, __("Vietnamese (vi)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:370
"Add your products, services and plans below. You can add multiple products and conditionally process each one based on your form data." => array( null, __("Add your products, services and plans below. You can add multiple products and conditionally process each one based on your form data.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:470
"Note: You'll need to configure conditions on each product to let Forminator know when to process each of the products below." => array( null, __("Note: You'll need to configure conditions on each product to let Forminator know when to process each of the products below.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:491
"There is an error in one or more of your products. Please review the error and try again." => array( null, __("There is an error in one or more of your products. Please review the error and try again.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:518
"Checkout Experience" => array( null, __("Checkout Experience", "forminator"), ), // src/form/components/fields/stripe-ocs.js:548
"Configure customer information and checkout behavior for Stripe Checkout." => array( null, __("Configure customer information and checkout behavior for Stripe Checkout.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:556
"Enhanced Checkout" => array( null, __("Enhanced Checkout", "forminator"), ), // src/form/components/fields/stripe-ocs.js:571
"Standard Checkout" => array( null, __("Standard Checkout", "forminator"), ), // src/form/components/fields/stripe-ocs.js:580
"Customers pay using a compact payment field on your form. " => array( null, __("Customers pay using a compact payment field on your form. ", "forminator"), ), // src/form/components/fields/stripe-ocs.js:585
"Adaptive Pricing" => array( null, __("Adaptive Pricing", "forminator"), ), // src/form/components/fields/stripe-ocs.js:594
"Show prices in your customer's local currency during checkout. Please ensure Adaptive Pricing is enabled in your {{adaptivePricingLink}}Stripe Dashboard{{/adaptivePricingLink}}." => array( null, __("Show prices in your customer's local currency during checkout. Please ensure Adaptive Pricing is enabled in your {{adaptivePricingLink}}Stripe Dashboard{{/adaptivePricingLink}}.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:598
"Your charge currency must be one of your Stripe settlement currencies. If needed, add currencies in {{settlementCurrenciesLink}}Stripe payouts settings{{/settlementCurrenciesLink}} before using Adaptive Pricing." => array( null, __("Your charge currency must be one of your Stripe settlement currencies. If needed, add currencies in {{settlementCurrenciesLink}}Stripe payouts settings{{/settlementCurrenciesLink}} before using Adaptive Pricing.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:623
"Note: Adaptive Pricing is unavailable for forms that use dynamic pricing." => array( null, __("Note: Adaptive Pricing is unavailable for forms that use dynamic pricing.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:650
"Switch any variable plan amount or quantity back to Fixed to enable Adaptive Pricing." => array( null, __("Switch any variable plan amount or quantity back to Fixed to enable Adaptive Pricing.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:654
"Checkout email" => array( null, __("Checkout email", "forminator"), ), // src/form/components/fields/stripe-ocs.js:664
"Use a Forminator Email field to prefill the customer's email in Stripe Checkout. If disabled or left unmapped, Stripe will ask the customer to enter their email during checkout." => array( null, __("Use a Forminator Email field to prefill the customer's email in Stripe Checkout. If disabled or left unmapped, Stripe will ask the customer to enter their email during checkout.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:666
"Email field" => array( null, __("Email field", "forminator"), ), // src/form/components/fields/stripe-ocs.js:676
"Checkout phone (optional)" => array( null, __("Checkout phone (optional)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:693
"Use a Forminator Phone field to prefill the customer's phone number in Stripe Checkout.  If disabled or left unmapped, no phone number will be collected." => array( null, __("Use a Forminator Phone field to prefill the customer's phone number in Stripe Checkout.  If disabled or left unmapped, no phone number will be collected.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:695
"Phone field" => array( null, __("Phone field", "forminator"), ), // src/form/components/fields/stripe-ocs.js:705
"Payment Methods" => array( null, __("Payment Methods", "forminator"), ), // src/form/components/fields/stripe-ocs.js:726
"Choose how customers can pay. The default option allows card payments only. To allow other payment methods like Venmo, Google Pay, or AliPay, select the Dynamic Payment Methods option below." => array( null, __("Choose how customers can pay. The default option allows card payments only. To allow other payment methods like Venmo, Google Pay, or AliPay, select the Dynamic Payment Methods option below.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:734
"Dynamic Payment Methods" => array( null, __("Dynamic Payment Methods", "forminator"), ), // src/form/components/fields/stripe-ocs.js:751
"You’ve selected dynamic payment methods. Please configure accepted payment methods on your {{link}}Stripe Dashboard{{/link}}." => array( null, __("You’ve selected dynamic payment methods. Please configure accepted payment methods on your {{link}}Stripe Dashboard{{/link}}.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:759
"Note: Only payment methods with immediate confirmation are supported." => array( null, __("Note: Only payment methods with immediate confirmation are supported.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:784
"{{link}}Learn more{{/link}}." => array( null, __("{{link}}Learn more{{/link}}.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:786
"Cards Only" => array( null, __("Cards Only", "forminator"), ), // src/form/components/fields/stripe-ocs.js:808
"Use these below options to enable and configure additional options for your Stripe payment." => array( null, __("Use these below options to enable and configure additional options for your Stripe payment.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:887
"Send Payment Receipt" => array( null, __("Send Payment Receipt", "forminator"), ), // src/form/components/fields/stripe-ocs.js:895
"You can enable or disable Payment Receipt emails in your {{link}}Stripe Dashboard{{/link}}. Note that Stripe sends the email receipt only for live payments." => array( null, __("You can enable or disable Payment Receipt emails in your {{link}}Stripe Dashboard{{/link}}. Note that Stripe sends the email receipt only for live payments.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:929
"Choose whether you want Stripe to email a receipt to your customers on successful payment. Note that Stripe sends the email receipt only for live payments." => array( null, __("Choose whether you want Stripe to email a receipt to your customers on successful payment. Note that Stripe sends the email receipt only for live payments.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:936
"Enable Billing Details" => array( null, __("Enable Billing Details", "forminator"), ), // src/form/components/fields/stripe-ocs.js:942
"Customer phone number (optional)" => array( null, __("Customer phone number (optional)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:992
"Select a phone field" => array( null, __("Select a phone field", "forminator"), ), // src/form/components/fields/stripe-ocs.js:994
"Payment Element Layout" => array( null, __("Payment Element Layout", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1106
"Choose the Payment Element’s layout that fits your checkout flow." => array( null, __("Choose the Payment Element’s layout that fits your checkout flow.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1114
"Tabs" => array( null, __("Tabs", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1128
"Accordion with radio buttons" => array( null, __("Accordion with radio buttons", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1137
"Accordion without radio buttons" => array( null, __("Accordion without radio buttons", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1146
"Select a theme from the Stripe Appearance API to control the style of all elements." => array( null, __("Select a theme from the Stripe Appearance API to control the style of all elements.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1179
"Night" => array( null, __("Night", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1188
"Customize Appearance" => array( null, __("Customize Appearance", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1197
"Customize Colors" => array( null, __("Customize Colors", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1204
"Primary color" => array( null, __("Primary color", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1209
"Error" => array( null, __("Error", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1230
"Other options" => array( null, __("Other options", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1238
"Border radius" => array( null, __("Border radius", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1271
...
"Future Date" => array( null, __("Future Date", "forminator"), ), // src/form/components/fields/date.js:444
"Year Range" => array( null, __("Year Range", "forminator"), ), // src/form/components/fields/date.js:460
"By default, we select 100 years in the past, and 100 years in the future for the year dropdown field. You can set a custom year range to display in the year dropdown below." => array( null, __("By default, we select 100 years in the past, and 100 years in the future for the year dropdown field. You can set a custom year range to display in the year dropdown below.", "forminator"), ), // src/form/components/fields/date.js:463
"From" => array( null, __("From", "forminator"), ), // src/form/components/fields/date.js:475
"1920" => array( null, __("1920", "forminator"), ), // src/form/components/fields/date.js:476
"To" => array( null, __("To", "forminator"), ), // src/form/components/fields/date.js:486
"2030" => array( null, __("2030", "forminator"), ), // src/form/components/fields/date.js:487
...
"This legacy Stripe (Card Element) field is deprecated and will be removed in an upcoming Forminator release. Update your form to the new Stripe Payment Element field to avoid failed payments." => array( null, __("This legacy Stripe (Card Element) field is deprecated and will be removed in an upcoming Forminator release. Update your form to the new Stripe Payment Element field to avoid failed payments.", "forminator"), ), // src/form/components/builder/field.js:1110
...
"Theme Fonts" => array( null, __("Theme Fonts", "forminator"), ), // src/form/components/appearance/fonts.js:213
"Response Message" => array( null, __("Response Message", "forminator"), ), // src/form/components/appearance/fonts.js:225
"Pagination Steps" => array( null, __("Pagination Steps", "forminator"), ), // src/form/components/appearance/fonts.js:240
"Pagination Progress Bar" => array( null, __("Pagination Progress Bar", "forminator"), ), // src/form/components/appearance/fonts.js:255
"Fields Label" => array( null, __("Fields Label", "forminator"), ), // src/form/components/appearance/fonts.js:270
"Fields Description" => array( null, __("Fields Description", "forminator"), ), // src/form/components/appearance/fonts.js:284
"Fields Error Message" => array( null, __("Fields Error Message", "forminator"), ), // src/form/components/appearance/fonts.js:298
"Input and Textarea" => array( null, __("Input and Textarea", "forminator"), ), // src/form/components/appearance/fonts.js:346
"Input Prefix" => array( null, __("Input Prefix", "forminator"), ), // src/form/components/appearance/fonts.js:360
"Input Suffix" => array( null, __("Input Suffix", "forminator"), ), // src/form/components/appearance/fonts.js:377
"Radio and Checkbox" => array( null, __("Radio and Checkbox", "forminator"), ), // src/form/components/appearance/fonts.js:397
"Dropdown" => array( null, __("Dropdown", "forminator"), ), // src/form/components/appearance/fonts.js:435
"Multi Select" => array( null, __("Multi Select", "forminator"), ), // src/form/components/appearance/fonts.js:469
...
"Single File Upload" => array( null, __("Single File Upload", "forminator"), ), // src/form/components/appearance/fonts.js:510
"Upload Button" => array( null, __("Upload Button", "forminator"), ), // src/form/components/appearance/fonts.js:523
"File Name" => array( null, __("File Name", "forminator"), ), // src/form/components/appearance/fonts.js:534
"Multiple Files Upload" => array( null, __("Multiple Files Upload", "forminator"), ), // src/form/components/appearance/fonts.js:550
"Upload Panel" => array( null, __("Upload Panel", "forminator"), ), // src/form/components/appearance/fonts.js:563
"File Size" => array( null, __("File Size", "forminator"), ), // src/form/components/appearance/fonts.js:585
"E-Signature Placeholder" => array( null, __("E-Signature Placeholder", "forminator"), ), // src/form/components/appearance/fonts.js:601
"Repeater Button" => array( null, __("Repeater Button", "forminator"), ), // src/form/components/appearance/fonts.js:619
"Pagination Buttons" => array( null, __("Pagination Buttons", "forminator"), ), // src/form/components/appearance/fonts.js:636
"Slider selected value" => array( null, __("Slider selected value", "forminator"), ), // src/form/components/appearance/fonts.js:653
"Slider step values" => array( null, __("Slider step values", "forminator"), ), // src/form/components/appearance/fonts.js:666
...
"Single File Uploader" => array( null, __("Single File Uploader", "forminator"), ), // src/form/components/appearance/colors/uploaded-files.js:39
"Multiple Files Uploader" => array( null, __("Multiple Files Uploader", "forminator"), ), // src/form/components/appearance/colors/uploaded-files.js:52
"Uploaded File" => array( null, __("Uploaded File", "forminator"), ), // src/form/components/appearance/colors/uploaded-files.js:59
"Uploaded File Delete Button" => array( null, __("Uploaded File Delete Button", "forminator"), ), // src/form/components/appearance/colors/uploaded-files.js:69
